module github.com/fomiller/aws-infrastructure/lambda/src
...
require (
	...
	github.com/yogeshlonkar/aws-lambda-go-test v1.2.0
...
require (
	...
	github.com/fomiller/assume-role v0.1.2 // indirect
